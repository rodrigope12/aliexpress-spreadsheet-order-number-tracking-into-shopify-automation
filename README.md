# 📦 AliExpress to Shopify Tracker Sync

![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white)

## 🚀 Overview
Automated pipeline to synchronize order tracking numbers from AliExpress suppliers directly into Shopify stores, streamlining dropshipping operations.
...
## 🛠️ Technology Stack
*   **Core**: Shopify Api, Automation, Dropshipping
*   **Infrastructure**: Git, Local Environment

## 📦 Installation & Setup
```bash
# Clone the repository
git clone https://github.com/rodrigope12/aliexpress:-spreadsheet-order-number-tracking-into-shopify-automation.git
